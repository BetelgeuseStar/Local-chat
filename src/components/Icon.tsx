...
function Icon({ type, className, ...props }: IconProps) {
	switch (type) {
		case 'smiley-face':
			return (
				<svg className={className} {...props} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
					viewBox="0 0 485 485" >
					<g>
		...
		case 'citation':
			return (
				<svg className={className} {...props} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
					viewBox="0 0 459 459">
					<g>
						<g id="reply">
